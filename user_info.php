                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="info-value">
                                ...
                                <p><?php echo htmlspecialchars($user['name_bn'] ?? 'প্রদান করা হয়নি'); ?></p>
                            </div>
                            <div class="info-value">
                                <span class="info-label">ইংরেজি নাম:</span>
                                <p><?php echo htmlspecialchars($user['name_en'] ?? 'প্রদান করা হয়নি'); ?></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-header">
                            ...
                            <div class="info-value">
                                ...
                                <p><?php echo htmlspecialchars($user['father_name'] ?? 'প্রদান করা হয়নি'); ?></p>
                            </div>
                            <div class="info-value">
                                <span class="info-label">মাতার নাম:</span>
                                <p><?php echo htmlspecialchars($user['mother_name'] ?? 'প্রদান করা হয়নি'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <div class="info-value">
                                ...
                                <p><?php echo $formatted_dob; ?></p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="info-value">
                                <span class="info-label">রক্তের গ্রুপ:</span>
                                <p><?php echo htmlspecialchars($user['blood_group'] ?? 'প্রদান করা হয়নি'); ?></p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="info-value">
                                ...
                                <p>
                                    ছেলে: <?php echo $user['sons'] ?? 0; ?>, 
                                    মেয়ে: <?php echo $user['daughters'] ?? 0; ?>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="info-value">
                                ...
                                <p><?php echo htmlspecialchars($user['mobile'] ?? 'প্রদান করা হয়নি'); ?></p>
                            </div>
                            <div class="info-value">
                                <span class="info-label">ইমেইল:</span>
                                <p><?php echo htmlspecialchars($user['email'] ?? 'প্রদান করা হয়নি'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card info-card">
                        ...
                        <div class="card-body">
                            <div class="info-value">
                                ...
                                <p>পোস্ট অফিস: <?php echo htmlspecialchars($user['current_postoffice'] ?? 'প্রদান করা হয়নি'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card info-card">
                        ...
                        <div class="card-body">
                            <div class="info-value">
                                ...
                                <p>পোস্ট অফিস: <?php echo htmlspecialchars($user['permanent_postoffice'] ?? 'প্রদান করা হয়নি'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card info-card">
                ...
                <div class="card-body">
                    <div class="info-value">
                        ...
                        <p><?php echo htmlspecialchars($user['workplace_name'] ?? 'প্রদান করা হয়নি'); ?></p>
                    </div>
                    <div class="info-value">
                        <span class="info-label">কর্মস্থলের ঠিকানা:</span>
                        <p><?php echo htmlspecialchars($user['workplace_address'] ?? 'প্রদান করা হয়নি'); ?></p>
                    </div>
                    <div class="info-value">
                        <span class="info-label">কর্মস্থলের ইমেইল:</span>
                        <p><?php echo htmlspecialchars($user['workplace_email'] ?? 'প্রদান করা হয়নি'); ?></p>
                    </div>
                </div>
            </div>
        </div>
