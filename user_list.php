...
<?php require_once 'config.php'; // ডাটাবেস কানেকশন ?>
...
// Fetch records
$sql = "SELECT * FROM users WHERE name LIKE ? OR mobile LIKE ? ORDER BY id ASC LIMIT ?, ?";
                    ...
                    <table class="table table-bordered table-striped table-hover align-middle">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="user_profile.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm">
